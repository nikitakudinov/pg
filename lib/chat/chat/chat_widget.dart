            ...
            appBar: AppBar(
              ...
              title: FutureBuilder<List<ChatsRow>>(
                ...
                builder: (context, snapshot) {
                  ...
                  List<ChatsRow> columnChatsRowList = snapshot.data!;
                  final columnChatsRow = columnChatsRowList.isNotEmpty
                      ? columnChatsRowList.first
                      : null;
                  return Column(
