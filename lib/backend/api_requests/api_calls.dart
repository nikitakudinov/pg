...
class UpdatedteamsCall {
  Future<ApiCallResponse> call({
    String? time = '',
  }) async {
    return ApiManager.instance.makeApiCall(
      callName: 'UPDATEDTEAMS',
      apiUrl: '${TeamGroup.baseUrl}teams?team_updated_at=gt.${time}&select=*',
      callType: ApiCallType.GET,
      headers: {
        'apikey':
            'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyAgCiAgICAicm9sZSI6ICJhbm9uIiwKICAgICJpc3MiOiAic3VwYWJhc2UtZGVtbyIsCiAgICAiaWF0IjogMTY0MTc2OTIwMCwKICAgICJleHAiOiAxNzk5NTM1NjAwCn0.dc_X5iR_VP_qT0zsiyj_I_OZ2T9FtRU2BBNWN8Bu4GE',
...
class MessagingGroup {
  ...
  static GETCHATBYMEMBERScountCall gETCHATBYMEMBERScountCall =
...
class GetchatsCall {
  ...
  List<String>? chatschatmembersplayeruid(dynamic response) => (getJsonField(
        response,
...
class GETCHATBYMEMBERScountCall {
  Future<ApiCallResponse> call({
    String? uid1 = '',
    String? uid2 = '',
  }) async {
